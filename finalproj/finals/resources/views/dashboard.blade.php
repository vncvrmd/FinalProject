        ...
        <div class="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#0f2744] via-[#0a1628] to-[#0e7490] p-6 lg:p-8">
            ...
            <div class="relative flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('transactions.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-white text-primary-700 rounded-lg font-medium text-sm hover:bg-cyan-50 transition-colors shadow-lg shadow-cyan-500/20">
